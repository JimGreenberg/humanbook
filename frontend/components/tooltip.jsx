...
const Tooltip = (props) => {
  return(
    <div className={`tooltip ${props.tooltipClassName} ${props.id}`}>
...
export const placeTooltip = function(message, className, key='none', visibleFlag=true, buttonText="", callback=defaultCallback) {
  if (visibleFlag) {
  return (
      <Tooltip
        id={key}
